...
语法：
[![github](https://img.shields.io/badge/github-xiaoQiang-brightgreen.svg)](https://github.com/xiaoQiang)
```
...
![RUNOOB][img]
[img]: https://raw.githubusercontent.com/xiaoQiang/image_store/master/blog/md_logo.png
```
...
```html
<img src="https://raw.githubusercontent.com/xiaoQiang/image_store/master/blog/md_logo.png" width="50px" height="30px">
```
...
```markdown
![其他仓库的图片1](https://github.com/xiaoQiang/vue-music/raw/master/src/common/image/default.png)
或
![其他仓库的图片2](https://raw.githubusercontent.com/xiaoQiang/image_store/master/blog/md_logo.png)
