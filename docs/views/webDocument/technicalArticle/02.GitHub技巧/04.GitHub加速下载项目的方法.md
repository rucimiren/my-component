...
![](http://yaru.vip:8080/images/components/other/20200309112604.png)
...
2. 登录码云之后在页面右上角的加号选择`从GitHub/GitLab导入项目`
   ...
   ![](http://yaru.vip:8080/images/components/other/20200309112711.jpg)

   

3. 选择`从URL导入`，粘贴从GitHub复制来的仓库地址，然后导入，这个导入过程一般是很快的。

   ![](http://yaru.vip:8080/images/components/other/20200309112710.jpg)

4. 从码云克隆刚导入的这个项目，克隆速度会快很多，网速好的能达到几兆每秒（具体速度就看你的网速了，吐槽一下我家网速，总在关键时刻显示"视频加载中"....）

   ![](http://yaru.vip:8080/images/components/other/20200309112712.jpg)
